---
title: "Analysis of Census time series"
...
There are two methods, the first `see_question.numeric` takes a question number and prints it.

```{r see-question-numeric, fig.height=3}
see_question(3)
```

However, you can also provide one of the two-dimensional tables to see what question was asked that produced it (in 2016). 
For example, 
